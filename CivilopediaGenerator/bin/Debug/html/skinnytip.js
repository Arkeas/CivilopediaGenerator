...
function makeHTML(text, blnimage, title) {
	...
	if (!blnimage) {
		container_style += "background-image: url(\'/civilopedia/images/tipcentre.png\');";
		container_style += "line-height: 27px;";
	}
	else {
		container_style += "background-image: url(\'/civilopedia/images/small/PROMOTION_BLANK.png\'); height: 64px; width: 64px;";
	}
	...
	if (!blnimage)
		text = "<img src=\'/civilopedia/images/tipleft.png\' style=\'height: 27px; width: 6px;\' />" + text + "<img src=\'/civilopedia/images/tipright.png\' style=\'height: 27px; width: 6px;\' />";
...
function cboLanguage_SelectedIndexChanged() {
	...
	var strURL = "/civilopedia/" + strLanguage + strPage;
